...
#define _DECLARE_SCALAR_MEMBERS_AOS_CONSTVIEW_IMPL(VALUE_TYPE, CPP_TYPE, NAME, ARGS) \
  _SWITCH_ON_TYPE(VALUE_TYPE, /* Scalar */                                           \
                  std::add_const_t<CPP_TYPE>* BOOST_PP_CAT(NAME, _);                 \
                  , /* Column */                                                     \
                  , /* Eigen column */                                               \
  )
// clang-format on
 ...
 */
// clang-format off
#define _DECLARE_AOS_VIEW_CONST_SCALAR_ACCESSORS_IMPL(VALUE_TYPE, CPP_TYPE, NAME, ARGS)                               \
  _SWITCH_ON_TYPE(                                                                                                    \
      VALUE_TYPE,                                                                                        /* Scalar */ \
      SOA_HOST_DEVICE SOA_INLINE std::add_const_t<CPP_TYPE>& NAME() const { return base_type::NAME(); }, /* Column */ \
      , /* Eigen column */                                                                                            \
  )

#define _DECLARE_AOS_VIEW_CONST_SCALAR_ACCESSORS(R, DATA, TYPE_NAME)                        \
  BOOST_PP_IF(BOOST_PP_GREATER(BOOST_PP_TUPLE_ELEM(0, TYPE_NAME), _VALUE_LAST_COLUMN_TYPE), \
              BOOST_PP_EMPTY(),                                                             \
              BOOST_PP_EXPAND(_DECLARE_AOS_VIEW_CONST_SCALAR_ACCESSORS_IMPL TYPE_NAME))
...
#define _DECLARE_AOS_VIEW_SCALAR_ACCESSORS_IMPL(VALUE_TYPE, CPP_TYPE, NAME, ARGS)                                    \
  _SWITCH_ON_TYPE(                                                                                                   \
      VALUE_TYPE,                                                                                       /* Scalar */ \
      SOA_HOST_DEVICE SOA_INLINE CPP_TYPE& NAME() { return const_cast<CPP_TYPE&>(base_type::NAME()); }, /* Column */ \
      , /* Eigen column */                                                                                           \
  )
    ...
    struct ConstView {                                                                                                 \
      ...
      SOA_HOST_DEVICE SOA_INLINE const value_element& operator[] (size_type index) const {                             \
        if (index < 0 || index >= elements_) {                                                                         \
          SOA_THROW_OUT_OF_RANGE("Out of range index in AoSWrapper ::operator[]")                                      \
        }                                                                                                              \
        return aos_[index];                                                                                            \
      }                                                                                                                \
                                                                                                                       \
      _ITERATE_ON_ALL(_DECLARE_AOS_CONSTVIEW_SCALAR_ACCESSORS, ~, __VA_ARGS__)                                         \
                                                                                                                       \
      /* Trivial constuctor */                                                                                         \
      ConstView() = default;                                                                                           \
                                                                                                                       \
      ...
      private:                                                                                                         \
          size_type elements_ = 0;                                                                                     \
          value_element const* aos_ = nullptr;                                                                         \
    ...
    struct View : public ConstView {                                                                                   \
      ...
      SOA_HOST_DEVICE SOA_INLINE value_element& operator[] (size_type index) {                                         \
        return const_cast<value_element&>(ConstView::operator[](index));                                               \
                                                                                                                       ...
                                                                                                                       \
      _ITERATE_ON_ALL(_DECLARE_AOS_VIEW_CONST_SCALAR_ACCESSORS, ~, __VA_ARGS__)                                        \
