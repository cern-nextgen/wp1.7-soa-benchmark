...
struct RandomAccessAt {
    memlayout::size_t i;
    template <class... Args>
    __attribute__((always_inline)) constexpr ReturnType operator()(Args& ...args) const { return {args[i]...}; }
    template <class... Args>
    __attribute__((always_inline)) constexpr ReturnType operator()(const Args& ...args) const { return {args[i]...}; }
};
...
struct Wrapper<Struct, Container, Layout::aos> : public Container<Struct<value>> {
    ...
    __attribute__((always_inline)) constexpr Wrapper<Struct, reference> operator[] (size_t i) { return Base::operator[](i); }
    __attribute__((always_inline)) constexpr Wrapper<Struct, const_reference> operator[] (size_t i) const { return Base::operator[](i); }

    __attribute__((always_inline)) constexpr Wrapper<Struct, reference> operator*() { return operator[](0); }
    __attribute__((always_inline)) constexpr Wrapper<Struct, const_reference> operator*(ptrdiff_t) const { return operator[](0); }
};
...
struct Wrapper<Struct, pointer, Layout::aos> {
    ...
    __attribute__((always_inline)) constexpr Wrapper<Struct, reference> operator[] (size_t i) { return data[i]; }
    __attribute__((always_inline)) constexpr Wrapper<Struct, const_reference> operator[] (size_t i) const { return data[i]; }

    __attribute__((always_inline)) constexpr Wrapper<Struct, reference> operator*() { return *data; }
    __attribute__((always_inline)) constexpr Wrapper<Struct, const_reference> operator*(ptrdiff_t) const { return *data; }

    __attribute__((always_inline)) constexpr Wrapper<Struct, reference> operator->() { return operator[](0); }
    __attribute__((always_inline)) constexpr Wrapper<Struct, const_reference> operator->() const { return operator[](0); }
};
...
struct Wrapper<Struct, const_pointer, Layout::aos> {
    ...
    __attribute__((always_inline)) constexpr Wrapper<Struct, const_reference> operator[] (size_t i) const { return data[i]; }
    __attribute__((always_inline)) constexpr Wrapper<Struct, const_reference> operator*() const { return *data; }
    __attribute__((always_inline)) constexpr Wrapper<Struct, const_reference> operator->() const { return operator[](0); }
};
...
struct Wrapper<Struct, Container, Layout::soa> : public Struct<Container> {
    ...
    __attribute__((always_inline)) constexpr Wrapper<Struct, reference> operator[] (size_t i) { return Base::apply(RandomAccessAt<Struct<reference>>{i}); }
    __attribute__((always_inline)) constexpr Wrapper<Struct, const_reference> operator[] (size_t i) const { return Base::apply(RandomAccessAt<Struct<const_reference>>{i}); }
...
struct Wrapper<Struct, Container, Layout::soa> : public Struct<Container> {
    ...
    __attribute__((always_inline)) constexpr Wrapper<Struct, memlayout::reference> operator[] (size_t i) { return Base::apply(RandomAccessAt<Struct<memlayout::reference>>{i}); }
    __attribute__((always_inline)) constexpr const Wrapper<Struct, memlayout::const_reference> operator[] (size_t i) const { return Base::apply(RandomAccessAt<Struct<memlayout::const_reference>>{i}); }

    __attribute__((always_inline)) constexpr Wrapper<Struct, memlayout::reference> operator*() { return operator[](0); }
    __attribute__((always_inline)) constexpr Wrapper<Struct, memlayout::const_reference> operator*() const { return operator[](0); }
    __attribute__((always_inline)) constexpr Wrapper<Struct, memlayout::reference> operator->() { return operator[](0); }
    __attribute__((always_inline)) constexpr Wrapper<Struct, memlayout::const_reference> operator->() const { return operator[](0); }
